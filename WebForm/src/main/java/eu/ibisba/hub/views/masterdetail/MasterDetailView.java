package eu.ibisba.hub.views.masterdetail;

import org.springframework.beans.factory.annotation.Autowired;

import eu.ibisba.hub.backend.BackendService;
import eu.ibisba.hub.backend.IBISBAMember;
...
public class MasterDetailView extends Div implements AfterNavigationObserver {
    ...
    private Grid<IBISBAMember> employees;
    ...
    private Binder<IBISBAMember> binder;
    ...
    public MasterDetailView() {
        ...
        employees.addColumn(IBISBAMember::getFirstname).setHeader("First name");
        employees.addColumn(IBISBAMember::getLastname).setHeader("Last name");
        employees.addColumn(IBISBAMember::getEmail).setHeader("Email");

        //when a row is selected or deselected, populate form
        employees.asSingleSelect().addValueChangeListener(event -> populateForm(event.getValue()));

        // Configure Form
        binder = new Binder<>(IBISBAMember.class);
    ...
    private void populateForm(IBISBAMember value) {
